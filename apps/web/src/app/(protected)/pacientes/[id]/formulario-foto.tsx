  ...
  if (erro) {
    return (
      <a
        ...
        className="aspect-square bg-[#1A1A1A] border border-[#2A2209] rounded-md flex flex-col items-center justify-center gap-2 p-3 text-[#8A7A5A] hover:text-[#F5F0E8] hover:border-[#C9A84C]/40 transition-colors"
      >
        <ImageOff size={20} />
