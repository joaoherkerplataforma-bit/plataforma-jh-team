# Plataforma JH TEAM — João Herker Personal

**INSTRUÇÃO OBRIGATÓRIA**: Sempre leia o PROJETO.md antes de qualquer ação.

Stack: Next.js + TypeScript + Supabase + Vercel + Railway.
